                ...
                <div className="  relative">
                    <section className="flex flex-col gap-5">
                        ...
                        <section className="flex flex-col gap-4">
                            ...
                            <p className="text-justify md:text-base text-sm">
                                IJSIOT aims to provide a high-quality platform for researchers, academicians, and industry professionals to present and discuss innovative research and developments in the field of Smart Internet of Things (IoT) and its applications. The journal focuses on publishing original research, review articles, and case studies that contribute to advancements in IoT technologies, architectures, security, and real-world applications.
                            </p>
                        ...
                        <section className='  grid-cols-1  md:gap-10 gap-5'>
                            <div className='flex flex-col gap-2 md:text-base text-sm '>
                                ...
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>Edge, Fog, and Cloud Computing for IoT </span> – Distributed computing paradigms for IoT infrastructure</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>IoT Security, Privacy, and Blockchain</span> – Secure IoT frameworks, data protection, and trust management.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>AI and Machine Learning for IoT</span> –   Intelligent analytics, decision-making, and automation.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>Wireless Sensor Networks and Communication Protocols</span> – Connectivity solutions for IoT devices.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>Industrial IoT (IIoT) and Automation  </span> –   IoT applications in manufacturing, logistics, and smart factories.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>IoT in Smart Cities, Healthcare, and Agriculture   </span> – Innovations for urban management, patient monitoring, and precision farming.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>Big Data and IoT-driven Analytics  </span> – Data management, predictive analytics, and real-time insights.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>5G and Next-Generation IoT Networks  </span> –  Integration of advanced communication technologies.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>Cyber-Physical Systems and Digital Twins</span> – Real-world simulations and virtual models.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>IoT-Enabled Smart Homes, Wearables, and Transportation </span> – Enhancing daily life and mobility.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-sr-play text-xs  text-[#B49752]   flex items-center"></i>
                                    <p className=""><span className='text-[#2F1A00] font-semibold'>Sustainable IoT and Green Technologies  </span> – Energy-efficient solutions and environmental impact.</p>
                                </div>
                            </div>
                        </section>
                    </section>
